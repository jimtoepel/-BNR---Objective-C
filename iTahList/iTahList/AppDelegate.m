...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // Create and configure the UIWindow intance
    // A CGrext is a struch with an origin (x, y) and a size (width, height)
    ...
    // Create and confiuer the UITextField instance where new tasks will be entered
    ...
    // Add our three new UI elements to the window
